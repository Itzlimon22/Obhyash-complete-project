              ...
              {showRejectInput ? (
                ...
                <div className="flex justify-end gap-3">
                  <button
                    ...
                    className="px-6 py-2 text-red-600 border border-red-200 hover:bg-red-50 dark:border-red-900/30 dark:hover:bg-red-900/20 rounded-lg font-bold transition-colors disabled:opacity-50"
                  >
                    Reject
                  </button>
                </div>
