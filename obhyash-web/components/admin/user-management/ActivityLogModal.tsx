        ...
        <div className="p-4 border-b border-neutral-200 dark:border-neutral-800 flex gap-4 bg-neutral-50/50 dark:bg-neutral-900/50">
          <div className="flex-1 relative">
            ...
            <select
              ...
              className="w-full pl-9 pr-4 py-2 bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg text-sm text-neutral-900 dark:text-white focus:ring-2 focus:ring-emerald-500 outline-none"
            >
