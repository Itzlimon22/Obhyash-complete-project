          ...
          <tbody className="divide-y divide-neutral-200 dark:divide-neutral-800">
            {users.map((user) => (
              <tr
                ...
                onClick={(e) => {
                  // If clicking outside interactive elements, close menu
                  if (
                    showActionMenu &&
                          ...
                          <div className="px-4 py-2">
                            ...
                            <div className="flex gap-2">
                              <button
                                ...
                                className="flex-1 px-2 py-1.5 text-xs bg-neutral-100 dark:bg-neutral-700 hover:bg-neutral-200 dark:hover:bg-neutral-600 rounded-lg transition-colors font-medium"
                              >
                                Free
                              </button>
                              <button
                                ...
                                className="flex-1 px-2 py-1.5 text-xs bg-amber-100 dark:bg-amber-900/30 hover:bg-amber-200 dark:hover:bg-amber-900/50 text-amber-700 dark:text-amber-400 rounded-lg transition-colors font-medium"
                              >
                                Premium
                              </button>
                              <button
