...
const LandingPage: React.FC<LandingPageProps> = ({
  ...
  const faqs = [
    ...
    {
      q: 'প্রশ্নপত্র কতটা নির্ভুল?',
      a: 'আমরা আমাদের বিশাল প্রশ্ন ব্যাংক ব্যবহার করি যা প্রতিটি টপিক অনুযায়ী মানসম্মত প্রশ্ন প্রদান করতে সাহায্য করে। তবে আমরা সবসময় টেক্সটবুক ফলো করার পরামর্শ দেই।',
    },
    {
      q: 'সাবস্ক্রিপশন পেমেন্ট করার পদ্ধতি কী?',
      a: 'আমরা বাংলাদেশের জনপ্রিয় সব পেমেন্ট মেথড সাপোর্ট করি। তুমি bKash, নাগদ বা রকেটের মাধ্যমে খুব সহজেই পেমেন্ট করতে পারবেন। পেমেন্ট সম্পন্ন হওয়ার সাথে সাথেই তোমার অ্যাকাউন্ট প্রিমিয়াম ফিচারে আপডেট হয়ে যাবে।',
    },
    {
      q: 'আমি কি একাধিক ডিভাইসে অ্যাপটি ব্যবহার করতে পারবো?',
      a: 'হ্যাঁ, তুমি একই অ্যাকাউন্ট দিয়ে স্মার্টফোন, ট্যাবলেট এবং পিসিতে লগইন করতে পারবেন। তোমার সব এক্সাম রেকর্ড এবং ডাটা ক্লাউডে সুরক্ষিত থাকবে, ফলে তুমি যেকোনো ডিভাইস থেকে নিজের অগ্রগতি দেখতে পাবেন।',
    },
    {
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 lg:px-6">
        <div className="mb-12 text-center">
          ...
          <p className="text-neutral-600 dark:text-neutral-400 mt-4 max-w-2xl mx-auto">
            Obhyash অ্যাপে রয়েছে তোমার প্রস্তুতির প্রতিটি ধাপের জন্য অত্যাধুনিক
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-6 mb-8">
          ...
          <div className="lg:col-span-3 p-8 rounded-3xl bg-white dark:bg-black border border-neutral-100 dark:border-neutral-800 shadow-sm relative overflow-hidden group hover:border-red-200 dark:hover:border-red-900 transition-all">
            ...
            তোমার প্রয়োজন অনুযায়ী তৈরি করো প্রশ্নপত্র। বিষয়, অধ্যায়, টপিক এবং
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
            <div className="space-y-3">
              ...
              <p className="text-neutral-400 text-sm leading-relaxed">
                প্রতিটি বিষয়ের জন্য রয়েছে সমৃদ্ধ প্রশ্ন ব্যাংক এবং নির্ভুল
                সমাধান।
              </p>
            </div>
            <div className="space-y-3">
            ...
            <div className="flex flex-col lg:flex-row gap-12 items-center">
              <div className="lg:w-1/3 space-y-6">
                ...
                <p className="text-neutral-600 dark:text-neutral-400 text-lg">
                  তোমার স্বপ্ন ছোঁয়ার যাত্রায় আমাদের সেরা টিপস ও গাইডলাইনগুলো
                  দেখে নাও। প্রতিটি পোস্ট তোমার প্রস্তুতিকে আরও সহজ করবে।
                </p>
                <Link
                  href="/blog"
      ...
      >
        <div className="max-w-7xl mx-auto px-4 lg:px-6 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-neutral-900 dark:text-white mt-2">
              তোমার পছন্দের প্ল্যানটি বেছে নাও
            </h2>
            <p className="text-neutral-600 dark:text-neutral-400 mt-4 max-w-2xl mx-auto">
              আমাদের সাশ্রয়ী সাবস্ক্রিপশন প্ল্যানগুলোর মাধ্যমে তোমার প্রস্তুতিকে
