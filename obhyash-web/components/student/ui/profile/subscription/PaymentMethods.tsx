      ...
      <div className="space-y-3">
        {methods.length === 0 ? (
          <p className="text-neutral-500 dark:text-neutral-400 text-sm">
            কোনো পেমেন্ট মেথড যুক্ত করা হয়নি।
          </p>
        ) : (
          methods.map((method) => (
            <div
              key={method.id}
              className="flex items-center justify-between p-4 rounded-xl border border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-800/30"
            >
                ...
                <div>
                  <p className="font-bold text-neutral-800 dark:text-white text-sm">
                    {method.type === 'card'
                      ...
                      : `${method.type === 'bkash' ? 'bKash' : 'Nagad'} - ${method.number}`}
                  </p>
                  {method.expiry && (
              ...
              <div className="flex items-center gap-3">
                {method.isDefault && (
                  <span className="px-2 py-0.5 bg-neutral-200 dark:bg-neutral-700 text-neutral-600 dark:text-neutral-300 text-[10px] font-bold uppercase rounded">
                    Default
                  </span>
                )}
                <button
