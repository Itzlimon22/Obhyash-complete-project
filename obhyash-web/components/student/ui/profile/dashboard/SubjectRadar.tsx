...
const SubjectRadar: React.FC<SubjectRadarProps> = ({ data }) => {
  return (
    <div className="bg-white dark:bg-neutral-900 rounded-2xl shadow-sm border border-neutral-200 dark:border-neutral-800 p-6 flex flex-col">
      ...
      <div className="mt-2 text-center">
        <span className="text-xs bg-neutral-100 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-400 px-2 py-1 rounded">
