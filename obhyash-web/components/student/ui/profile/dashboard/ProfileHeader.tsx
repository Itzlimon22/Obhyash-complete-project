        ...
        <div className="flex-1 w-full space-y-4">
          <div className="flex items-start justify-between gap-4">
            <div className="text-left space-y-1">
              ...
              <p className="text-sm md:text-lg text-neutral-500 dark:text-neutral-400 font-medium line-clamp-1">
                {user.institute}
              </p>
            </div>
            ...
            <button
              onClick={onEdit}
              className="md:hidden shrink-0 p-2.5 bg-neutral-100 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-300 rounded-xl border border-neutral-200 dark:border-neutral-700 active:scale-95 transition-all"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
            ...
            <button
              onClick={onEdit}
              className="hidden md:flex px-5 py-2.5 bg-white dark:bg-neutral-800 hover:bg-neutral-50 dark:hover:bg-neutral-700 text-neutral-700 dark:text-neutral-200 font-bold text-sm rounded-xl border border-neutral-200 dark:border-neutral-700 transition-colors shadow-sm items-center justify-center gap-2"
            >
              এডিট প্রোফাইল
            </button>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3">
            <div className="flex items-center gap-2 px-3 py-1.5 bg-neutral-100 dark:bg-neutral-800 rounded-lg border border-neutral-200 dark:border-neutral-700">
              <span className="text-[10px] md:text-xs font-bold text-neutral-500 uppercase">
                Target
              </span>
              <span className="text-xs md:text-sm font-bold text-neutral-800 dark:text-white">
                {user.target || 'Not Set'}
              </span>
            </div>
            ...
            <div className="flex items-center gap-2 px-3 py-1.5 bg-amber-50 dark:bg-amber-900/10 rounded-lg border border-amber-100 dark:border-amber-800/30 text-amber-700 dark:text-amber-500">
              ...
              <span className="text-xs md:text-sm font-bold">{user.level}</span>
            </div>
          </div>
        </div>
      </div>
