          ...
          return (
            <button
              ...
              className={`
                            ...
                            ${
                              isSelected
                                ? `border-transparent ring-2 ring-offset-2 ring-emerald-500 dark:ring-offset-neutral-950 shadow-lg scale-105`
            ...
            >
              {/* User Badge */}
              {isUserLevel && (
                <div className="absolute top-2 right-2 w-2 h-2 md:w-2.5 md:h-2.5 bg-emerald-500 rounded-full animate-pulse shadow-sm"></div>
              )}
