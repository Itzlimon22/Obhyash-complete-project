  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8 animate-fade-in pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-12">
         {[1, 2, 3].map(i => (
             <div key={i} className="bg-white dark:bg-neutral-900 p-6 rounded-2xl shadow-sm border border-neutral-200 dark:border-neutral-800 flex flex-col items-center justify-center h-48 relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto space-y-6">
         ...
         {[1, 2].map(i => (
             <div key={i} className="bg-white dark:bg-neutral-900 rounded-2xl border border-neutral-200 dark:border-neutral-800 p-6 overflow-hidden relative">
                 <div className="absolute inset-0 bg-gradient-to-r from-transparent via-neutral-50 dark:via-neutral-800/50 to-transparent -tranneutral-x-full animate-[shimmer_1.5s_infinite]"></div>
                 ...
                 <div className="space-y-3">
                     ...
                     {[1, 2, 3, 4].map(j => (
                         <div key={j} className="h-12 w-full bg-neutral-100 dark:bg-neutral-800/50 rounded-xl animate-pulse"></div>
                     ))}
                 </div>
             </div>
         ))}
