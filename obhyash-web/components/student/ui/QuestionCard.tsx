      ...
      <div className="flex items-center justify-between px-4 py-3 md:px-6 md:py-4 border-b border-neutral-100 dark:border-neutral-800 bg-white dark:bg-neutral-900">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-sm md:text-base font-bold text-neutral-800 dark:text-neutral-200 leading-none">
            ...
            return (
              <label
                ...
                className={`
                  ...
                  ${
                    isSelected
                      ? 'bg-emerald-50/60 dark:bg-emerald-900/20 border-emerald-600 dark:border-emerald-500 shadow-sm'
                      : 'bg-white dark:bg-neutral-900 border-neutral-200 dark:border-neutral-800 hover:border-neutral-300 dark:hover:border-neutral-700 hover:bg-neutral-50 dark:hover:bg-neutral-800'
                  }
                `}
              >
                <input
                ...
                {/* Option Text */}
                <span
                  className={`text-sm md:text-[17px] font-medium leading-normal flex-1 ${isSelected ? 'text-emerald-900 dark:text-emerald-200' : 'text-neutral-700 dark:text-neutral-300'}`}
                >
                ...
                <div
                  className={`
                    ...
                    ${isSelected ? 'border-emerald-600 bg-emerald-600' : 'border-neutral-300 dark:border-neutral-600'}
                `}
                >
                  {isSelected && (
                    <svg
