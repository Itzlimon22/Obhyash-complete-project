          ...
          return (
            <button
              ...
              className={`
                            ...
                            ${
                              isSelected
                                ? `border-transparent ring-2 ring-offset-2 ring-indigo-500 dark:ring-offset-neutral-950 shadow-lg scale-105`
                                : 'border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 hover:border-neutral-300 dark:hover:border-neutral-700'
                            }
                        `}
            >
              {isUserLevel && (
                <div className="absolute top-2 right-2 w-2 h-2 md:w-2.5 md:h-2.5 bg-indigo-500 rounded-full animate-pulse shadow-sm"></div>
              )}
              {isSelected && (
                <div
