...
export const LiveExamSession: React.FC<LiveExamSessionProps> = ({
  ...
  if (engine.appState === AppState.ERROR) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen text-red-500 font-['HindSiliguri']">
  ...
  if (engine.appState === AppState.COMPLETED) {
    ...
    return (
      <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#09090B] flex items-center justify-center p-4 font-['HindSiliguri']">
        <div className="w-full max-w-xl bg-white dark:bg-[#18181B] rounded-3xl p-6 sm:p-8 border border-[#E2E8F0] dark:border-[#27272A] shadow-xl text-center space-y-6 animate-in fade-in zoom-in-95 duration-300">
          {/* Header Trophy Icon */}
