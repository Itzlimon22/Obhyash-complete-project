    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto text-black bg-white">
        ...
        <div className="grid gap-6 py-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 bg-neutral-50 rounded-lg border">
            ...
            <div className="space-y-2">
              <Label className="text-xs text-neutral-500 uppercase">Year</Label>
              <Input
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              />
              {/* Preview Box */}
              <div className="p-4 bg-neutral-50 border rounded-md min-h-[60px]">
                <p className="text-[10px] text-neutral-400 mb-1 uppercase tracking-wider">
                  Preview
                </p>
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {formData.options.map((opt, i) => (
                <div
                  key={opt.id || i}
                  className="p-3 border rounded-lg bg-neutral-50/50 space-y-2"
                >
                  ...
                  <div className="flex gap-2 items-start">
                    {/* ID Badge */}
                    <div
                      className={`flex items-center justify-center w-8 h-10 rounded text-sm font-bold shrink-0 ${opt.isCorrect ? 'bg-emerald-100 text-emerald-700' : 'bg-white border text-neutral-500'}`}
                    >
                      {opt.id}
                    </div>
                    ...
                    <div className="flex-1 space-y-2">
                      ...
                      {opt.image_url && (
                        <div className="relative w-full h-20 rounded border overflow-hidden bg-neutral-100 group">
                  ...
                  {opt.text && (
                    <div className="pl-10">
                      <div className="text-xs bg-white px-2 py-1 rounded border text-neutral-600 overflow-hidden text-ellipsis">
          ...
          <div className="space-y-2">
            ...
            {formData.explanation_image_url && (
              <div className="w-full h-32 relative border rounded bg-neutral-50 mb-2 group">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
            ...
            {formData.explanation && (
              <div className="p-3 bg-neutral-50 border rounded-md text-sm">
                <p className="text-[10px] text-neutral-400 mb-1 uppercase">
                  Solution Preview
                </p>
