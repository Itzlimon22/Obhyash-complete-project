-- ==============================================================================
-- FIX: 003_fix_users_table_privilege_escalation.sql
-- DESCRIPTION: Eliminates Client-Side Privilege Escalation on public.users.
--              Ordinary users CANNOT modify role, subscription, status, xp, level,
--              or plan. Only Admins and Service Role backend APIs can modify them.
-- ==============================================================================
...
-- Allow users to view profiles (for leaderboards and self profile)
...
-- Allow users to update ONLY their own record (Privileged columns are guarded by trigger above)
...
DO $$
BEGIN
    RAISE NOTICE '✅ [003] Privilege escalation on public.users successfully locked down!';
END $$;
