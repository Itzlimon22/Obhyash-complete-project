class BanglaNameHelper {
  ...
  static List<String> getSearchVariations(String raw) {
    ...
    for (final item in rawList) {
      ...
      if (sanitized.contains('পর্যায়বৃত্ত') || sanitized.contains('পর্যায়বৃত্ত') || sanitized.contains('পর্যাবৃত্ত')) {
        variants.add('পর্যায়বৃত্ত গতি');
        variants.add('পর্যায়বৃত্ত গতি');
        variants.add('পর্যাবৃত্ত গতি');
      }

      if (sanitized.contains('আবেশ')) {
        variants.add('তাড়িতচৌম্বকীয় আবেশ ও দিক পরিবর্তী প্রবাহ');
        variants.add('তাড়িতচৌম্বকীয় আবেশ ও দিক পরিবর্তী প্রবাহ');
        variants.add('তড়িৎ চৌম্বক আবেশ ও পরিবর্তী প্রবাহ');
        variants.add('তড়িৎ চৌম্বক আবেশ ও পরিবর্তী প্রবাহ');
      }

      if (sanitized.contains('পরমাণু') || sanitized.contains('নিউক্লিয়ার') || sanitized.contains('নিউক্লিয়ার')) {
        variants.add('পরমাণুর মডেল এবং নিউক্লিয়ার পদার্থবিজ্ঞান');
        variants.add('পরমাণুর মডেল এবং নিউক্লিয়ার পদার্থবিজ্ঞান');
        variants.add('পরমাণুর মডেল ও নিউক্লিয়ার পদার্থবিজ্ঞান');
        variants.add('পরমাণুর মডেল ও নিউক্লিয়ার পদার্থবিজ্ঞান');
      }

      if (sanitized.contains('চৌম্বক')) {
        variants.add('তড়িৎ প্রবাহের চৌম্বক ক্রিয়া ও চুম্বকত্ব');
        variants.add('তড়িৎ প্রবাহের চৌম্বক ক্রিয়া ও চুম্বকত্ব');
      }
    }
  ...
  static List<String> getChapterSearchVariants(String chapterName) {
    ...
    } else if (raw.contains('পর্যায়বৃত্ত') || raw.contains('পর্যায়বৃত্ত') || raw.contains('পর্যাবৃত্ত')) {
      variants.addAll(['পর্যায়বৃত্ত গতি', 'পর্যায়বৃত্ত গতি', 'পর্যাবৃত্ত গতি', 'পর্যায়বৃত্ত', 'পর্যায়বৃত্ত', 'পর্যাবৃত্ত']);
    ...
    // Physics 2nd Paper
      ...
      variants.addAll([
        'তাড়িতচৌম্বকীয় আবেশ ও দিক পরিবর্তী প্রবাহ', 'তাড়িতচৌম্বকীয় আবেশ ও দিক পরিবর্তী প্রবাহ',
        'তাড়িতচৌম্বকীয় আবেশ ও পরিবর্তী প্রবাহ', 'তাড়িতচৌম্বকীয় আবেশ ও পরিবর্তী প্রবাহ',
        'তড়িৎ চৌম্বক আবেশ ও পরিবর্তী প্রবাহ', 'তড়িৎ চৌম্বক আবেশ ও পরিবর্তী প্রবাহ',
      ...
      variants.addAll([
        'পরমাণুর মডেল এবং নিউক্লিয়ার পদার্থবিজ্ঞান', 'পরমাণুর মডেল এবং নিউক্লিয়ার পদার্থবিজ্ঞান',
        'পরমাণুর মডেল ও নিউক্লিয়ার পদার্থবিজ্ঞান', 'পরমাণুর মডেল ও নিউক্লিয়ার পদার্থবিজ্ঞান',
        'পরমাণুর মডেল', 'নিউক্লিয়ার পদার্থবিজ্ঞান', 'নিউক্লিয়ার পদার্থবিজ্ঞান',
      ]);
