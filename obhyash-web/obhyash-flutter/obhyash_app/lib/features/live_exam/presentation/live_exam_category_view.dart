...
class LiveExamCategoryView extends ConsumerStatefulWidget {
  ...
  const LiveExamCategoryView({
    super.key,
    required this.category,
  });

  @override
  ConsumerState<LiveExamCategoryView> createState() => _LiveExamCategoryViewState();
}
...
class _LiveExamCategoryViewState extends ConsumerState<LiveExamCategoryView> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ref.read(liveExamCategoryProvider.notifier).updateCategory(widget.category);
    });
  }
            ...
            Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  prefixIcon: const Icon(LucideIcons.search, color: Color(0xFFA3A3A3)),
                  ...
                  child: Row(
                    ...
                    children: ['All', 'Ongoing', 'Upcoming'].map((f) {
                      ...
                      return GestureDetector(
                        onTap: () {
                          ref.read(liveExamFilterProvider.notifier).updateFilter(f);
                        },
                        child: AnimatedContainer(
                          ...
                          decoration: BoxDecoration(
                            color: isActive
                                ? const Color(0xFF1D8A43) // web app specific green
                                : Colors.transparent,
                            borderRadius: BorderRadius.circular(30),
                            boxShadow: isActive
                                ? const [
                ...
                Row(
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: isDark ? const Color(0xFF1E3A8A).withOpacity(0.3) : const Color(0xFFE8F0FE),
                        borderRadius: BorderRadius.circular(30),
                      ),
                      child: Row(
                        children: [
...
class _LiveExamCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Color statusColor = isDark ? const Color(0xFF60A5FA) : const Color(0xFF2563EB); // blue
    Color statusBg = isDark ? const Color(0xFF1E3A8A).withOpacity(0.3) : const Color(0xFFEFF6FF);

    if (exam.isOngoing) {
      statusText = "Ongoing";
      statusColor = isDark ? const Color(0xFF4ADE80) : const Color(0xFF2CA05A); // green
      statusBg = isDark ? const Color(0xFF14532D).withOpacity(0.3) : const Color(0xFFEBFAEF);
    } else if (exam.isPast) {
      statusText = "Past";
      statusColor = isDark ? const Color(0xFFA3A3A3) : const Color(0xFF737373); // gray
    ...
    final timeDisplay = now.isAfter(exam.startTime) ? '$daysDiff দিন আগে' : 'বাকি - $daysDiff দিন';
