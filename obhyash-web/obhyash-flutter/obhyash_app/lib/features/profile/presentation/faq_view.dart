...
const List<FaqItem> _kFaqList = [
  ...
  FaqItem(
    ...
    answer:
        'পেমেন্ট বা সাবস্ক্রিপশন পেজে গিয়ে "কুপন আছে?" বাটনে ট্যাপ করো। এরপর চলতি অফার কুপন (যেমন: PIONEER) লিখে "কুপন যোগ করো" বাটনে ক্লিক করলেই সাথে সাথে নির্ধারিত ডিসকাউন্ট প্রযোজ্য হবে।',
  ),
  FaqItem(
    category: 'অ্যাকাউন্ট',
