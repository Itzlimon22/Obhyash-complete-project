...
const List<FaqItem> _kFaqList = [
  ...
  FaqItem(
    ...
    answer:
        'পেমেন্ট সফল হওয়ার সাথে সাথেই স্বয়ংক্রিয়ভাবে ও তাত্ক্ষণিকভাবে (Instant Activation) তোমার অ্যাকাউন্টে প্রিমিয়াম ফিচার আনলক হয়ে যাবে। কোনো অপেক্ষার প্রয়োজন নেই।',
  ),
  FaqItem(
    category: 'পেমেন্ট',
  ...
  FaqItem(
    ...
    answer:
        'পেমেন্ট বা সাবস্ক্রিপশন পেজে গিয়ে "কুপন আছে?" বাটনে ট্যাপ করো। এরপর তোমার অ্যাম্বাসেডর বা অফার কুপন কোড লিখে "কুপন যোগ করো" বাটনে ক্লিক করলেই সাথে সাথে নির্ধারিত ডিসকাউন্ট প্রযোজ্য হবে।',
  ),
  FaqItem(
    category: 'অ্যাকাউন্ট',
