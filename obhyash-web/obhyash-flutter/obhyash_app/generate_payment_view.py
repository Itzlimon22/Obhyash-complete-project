...
class _PaymentViewState extends State<PaymentView>
  ...
  static const _merchantNumber = '01234567890'; // Updated to match web placeholder or use real one? Web uses 01234567890 in the instruction block but +8801946855793 for support. Let's use 01946855793.
  ...
  Future<void> _copyNumber() async {
    await Clipboard.setData(const ClipboardData(text: '01946855793'));
    if (mounted) {
  ...
  Future<void> _submit() async {
    ...
    if (!trxRegex.hasMatch(trxId)) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('সঠিক ট্রানজেকশন আইডি দিন')),
      );
      return;
    }
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: isDark ? const Color(0xFF0A0A0A).withValues(alpha: 0.8) : Colors.white.withValues(alpha: 0.8),
                border: Border(
                  bottom: BorderSide(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          'আমাদের টিম যাচাই করার পর দ্রুত আপনার প্ল্যানটি চালু করে দিবে।',
        ...
        children: [
            ...
            children: [
              ...
              Expanded(
                child: _summaryCard(
                  ...
                  borderColor: isDark ? const Color(0xFF7F1D1D).withValues(alpha: 0.3) : const Color(0xFFFEE2E2),
                  valueColor: isDark ? const Color(0xFFF87171) : const Color(0xFFDC2626), // red-400 : red-600
          ...
          if (_savedMethods.isNotEmpty) ...[
            ...
            ..._savedMethods.map((method) {
              final isSelected = _selectedMethod.toLowerCase() == method.type.toLowerCase() && 
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          child: Center(
                            child: Text(
                              method.type.toLowerCase() == 'bkash' ? 'bK' : method.type.toLowerCase() == 'nagad' ? 'N' : 'C',
          ...
          Container(
            ...
            child: DropdownButtonHideUnderline(
              child: DropdownButton<String>(
                ...
                icon: Icon(LucideIcons.chevronDown, color: isDark ? const Color(0xFFA3A3A3) : const Color(0xFF737373), size: 20),
                  ...
                  child: Row(
                    children: [
                      Container(
                        ...
                        height: 48,
                        decoration: BoxDecoration(
                          color: isDark ? item.$5.withValues(alpha: 0.1) : item.$5,
                          shape: BoxShape.circle,
                        ),
                        child: Center(
                          child: Text(
  ...
  Widget _summaryCard(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: bgColor,
        borderRadius: BorderRadius.circular(16),
        border: borderColor != null ? Border.all(color: borderColor) : Border.all(color: isDark ? const Color(0xFF262626) : const Color(0xFFE5E5E5)),
      ),
      child: Column(
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        border: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
          borderSide: BorderSide(color: isDark ? const Color(0xFF404040) : const Color(0xFFE5E5E5)),
        ),
...
"""
with open("lib/features/subscription/presentation/payment_view.dart", "w") as f:
    f.write(content)
