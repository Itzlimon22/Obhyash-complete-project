  ...
  const faqs = [
    {
      ...
      answer:
        "আমাদের একটি 'বেসিক' প্ল্যান আছে যা সম্পূর্ণ ফ্রি। এর মাধ্যমে আপনি প্রতিদিন ১টি পরীক্ষা দিতে পারবেন এবং বেসিক ফিচারগুলো ব্যবহার করতে পারবেন। তবে আনলিমিটেড এক্সাম, OMR স্ক্যান এবং অ্যাডভান্সড এনালাইসিসের জন্য প্রিমিয়াম সাবস্ক্রিপশন প্রয়োজন।",
    },
    {
      category: 'Exam',
      question: 'OMR স্ক্যান ফিচারটি কিভাবে কাজ করে?',
      answer:
        'খুবই সহজ! প্রথমে আপনি অ্যাপ থেকে প্রশ্ন দেখে বা প্রশ্নপত্র ডাউনলোড করে খাতায় পরীক্ষা দিন। এরপর অ্যাপের "OMR Scan" অপশনে গিয়ে আপনার উত্তরপত্রের ছবি তুলুন। আমাদের AI মাত্র কয়েক সেকেন্ডে আপনার খাতা যাচাই করে নির্ভুল ফলাফল এবং বিস্তারিত সমাধান দেখিয়ে দিবে।',
    },
    {
      category: 'Account',
    ...
    },
    {
      ...
      answer:
        'অবশ্যই! আমাদের সব প্রশ্ন সর্বশেষ NCTB সিলেবাস এবং বোর্ড পরীক্ষার মানবন্টন অনুযায়ী তৈরি করা হয়েছে। আমাদের এক্সপার্ট টিচার প্যানেল এবং AI প্রতিনিয়ত প্রশ্ন ব্যাংক আপডেট করে।',
    },
    {
      category: 'Payment',
      question: 'সাবস্ক্রিপশন কি ক্যান্সেল করা যায়?',
      answer:
        'Obhyash এ অটো-রিনিউয়াল সিস্টেম নেই, তাই সাবস্ক্রিপশন ক্যান্সেল করার ঝামেলা নেই। মেয়াদ শেষ হলে আপনার প্যাকেজ স্বয়ংক্রিয়ভাবে ফ্রি প্ল্যানে চলে আসবে, যতক্ষণ না আপনি পুনরায় রিনিউ করছেন।',
    },
    {
      category: 'Tech',
      question: 'অ্যাপ কাজ না করলে বা সমস্যা হলে কি করবো?',
      answer:
        'যেকোনো টেকনিক্যাল সমস্যায় আমাদের অ্যাপের "হেল্প" অপশন থেকে রিপোর্ট করতে পারেন। অথবা সরাসরি আমাদের সাপোর্ট ইমেইলে (support@obhyash.com) স্ক্রিনশটসহ মেইল করুন।',
    },
  ];
